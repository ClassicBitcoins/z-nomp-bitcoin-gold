...
function SetupForPool(logger, poolOptions, setupFinished){
    ...
    var getProperAddress = function(address){
        ...
        if (address.length < 25 || address.length > 34) {
            return (poolOptions.invalidAddress || (poolOptions.testnet === true ? "mq2DEepKdKG5HKUoJqVBmmyoVhNz8tSdGr" : "mpDrwVHKFP9RD2xPcW6q7wZy5bmWtpWbBR"));
        }

        if (poolOptions.testnet === true && address[0] !== 'm' && address[0] !== 'n' && address[0] !== '2') {
            return (poolOptions.invalidAddress || "mq2DEepKdKG5HKUoJqVBmmyoVhNz8tSdGr");
        }

        if (poolOptions.testnet === false && address[0] !== '1' && address[0] !== '3') {
            return (poolOptions.invalidAddress || "1DQUiK1an9iUkVygqZsiWrjqUMsRYMQ5h6");
        }
